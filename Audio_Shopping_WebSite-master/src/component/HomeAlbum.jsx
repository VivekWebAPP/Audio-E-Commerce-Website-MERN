    ...
    <section id='homeAlbum'>
      ...
      >
        ...
        <div className='albumBoxFullOrangeRight boxColumn gap_2 left'>
          ...
          <Link to={'/HeadPhones'} state={{ name: albumItem[0].name, desc: albumItem[0].desc, img: albumItem[0].img, pid: albumItem[0] }} className='btn_black selfLeft' >SEE PRODUCT</Link>
        </div>
      </motion.div>
      ...
      >
        <div className='albumBoxFullGrayLeft gap_2'>
          ...
          <Link to={'/Speakers'} state={{ name: albumItem[1].name, desc: albumItem[1].desc, img: albumItem[1].img, pid: albumItem[1] }} className='btn_transparent selfLeft' >SEE PRODUCT</Link>
        </div>
      ...
      <div className='albumBoxHulf boxRow'>
        ...
        >
          ...
          <Link to={'/EarPhones'} state={{ name: albumItem[2].name, desc: albumItem[2].desc, img: albumItem[2].img, pid: albumItem[2] }} className='btn_transparent selfLeft' >SEE PRODUCT</Link>
        </motion.div>
      </div>
    </section>
  )
