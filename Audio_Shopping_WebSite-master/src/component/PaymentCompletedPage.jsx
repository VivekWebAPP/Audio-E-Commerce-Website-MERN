...
const PaymentCompletedPage = () => {
    const { paymentSuccessfulProducts, totalPrice, orderID } = useCart();
    return (
                ...
                <div className="main-box border border-gray-200 rounded-xl pt-6 max-w-xl max-lg:mx-auto lg:max-w-full">
                    <div
                        ...
                        <div className="data">
                            ...
                            <p className="font-semibold text-base leading-7 text-black mt-4">Order Payment : <span className="text-gray-400 font-medium">{Date()}</span></p>
                        </div>
                        <button
                    ...
                    <div className="w-full px-3 min-[400px]:px-6">
                        {
                            paymentSuccessfulProducts.map((ele) => {
                                <div className="flex flex-col lg:flex-row items-center py-6 border-b border-gray-200 gap-6 w-full">
                                    <div className="img-box max-lg:w-full">
                                        <img src={ele.product.img} alt="Premium Watch image"
                                                ...
                                                <div className="">
                                                    ...
                                                    <div className="flex items-center ">
                                                        <p
                                                            ...
                                                            description: <span className="text-gray-500">{ele.product.desc}</span></p>
                                                        <p className="font-medium text-base leading-7 text-black ">Qty: <span
                                                            className="text-gray-500">{ele.count}</span></p>
                                                    </div>
                                                </div>
                                            ...
                                            <div className="grid grid-cols-5">
                                                <div className="col-span-5 lg:col-span-1 flex items-center max-lg:mt-3">
                                                    <div className="flex gap-3 lg:block">
                                                        ...
                                                        <p className="lg:mt-4 font-medium text-sm leading-7 text-indigo-600">Rs {ele.product.price}</p>
                                                    </div>
                                                </div>
                    ...
                    <div className="w-full border-t border-gray-200 px-6 flex flex-col lg:flex-row items-center justify-between ">
                        ...
                        <p className="font-semibold text-lg text-black py-6">Total Price: <span className="text-indigo-600"> Rs {totalPrice + 799 + 99}.00</span></p>
                    </div>
