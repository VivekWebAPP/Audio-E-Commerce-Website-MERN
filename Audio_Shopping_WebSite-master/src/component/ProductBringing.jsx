...
import bestGearImg from '../assets/New Products/Persion Image/Party_Animal_4.png';
    ...
    <section id='productBringing' className='boxRow boxWrap'>
      ...
      >
        ...
        <p className='opacity_50'>
            Located at the heart of New York City, AudioAce is the premier store for high end headphones, earphones, speakers, and audio accessories. We have a large showroom and luxury demonstration rooms available for you to browse and experience a wide range of our products. Stop by our store to meet some of the fantastic people who make Audiophile the best place to buy your portable audio equipment.
        </p>
      </motion.div>
      <motion.div 
        className='pBRight'
