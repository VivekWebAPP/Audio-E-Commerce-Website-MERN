...
function PCardList() {
  ...
  return (
    <>
    {
      location.state.restItems?location.state.restItems.map((item) => (
        <motion.div
        ...
        >
          ...
          <Link to={'/Product/' + item.name} state={{ name: item.name, desc: item.description, img: item.image, pid: item.id }} className='btn_orange' >ADD TO CART</Link>
        </motion.div>
