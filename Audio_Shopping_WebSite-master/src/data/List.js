...
import img_speaker_album from '../assets/New Products/Home Page Photo/homeAudioImage.png'
...
import img_earPhone from '../assets/New Products/Home Page Photo/HomeEarphoneImage-removebg-preview.jpg'
...
export const albumItem = [
    { id: 4, name: 'Rockerz 558 Sunburn Edition', img: img_speaker_album, navigate: '/Product', svg: img_pattern_circles_lg, desc: 'Wireless Headphone with 20 Hours Playback, 50mm Dynamic Drivers, Physical Noise Isolation' },
    { id: 5, name: 'Aavante Bar 2050', img: img_speaker2, navigate: '/Product', svg: '', desc: '' },
...
export const product_headphone = [
    ...
    { id: 9, delay: .5, name: 'Rockerz 558 Sunburn Edition', img: HEADPHONES3, isNew: true, desc: 'The new XX99 Mark II headphones is the pinnacle of pristine audio. It redefines your premium headphone experience by reproducing the balanced depth and precision of studio-quality sound.' },
]
